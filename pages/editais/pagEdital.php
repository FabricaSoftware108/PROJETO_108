        ...
        <div class="container">
            <div class="row">
                <div class="col-12" id="titulo-subtitulo-edital">
                    ...
                    <p style="text-align: justify;">O Senac, por meio de seu Programa de Gratuidade, destinado ao público de baixa renda, oferece a possibilidade de acesso aos cursos técnicos das fábricas. Deseja estar conosco neste projeto? Cadastre-se aqui.</p><br>
                </div>
            </div>
                                ...
                                <div class="row mx-4 my-4">
                                    <p class="d-inline-flex gap-1 mt-2 mb-1">
                                        <button class="btn bg-light rounded d-lg-flex d-sm-block justify-content-between align-items-center w-100 " data-bs-toggle="collapse" data-bs-target="#<?php echo $row["codigo"] ?>" aria-expanded="false" aria-controls="collapseExample" type="button">
                                            <div class="bg-<?php echo $dateColor ?> text-light px-4 rounded col-lg-3 col-sm-12"><?php echo $dateText ?></div>
                                            <div class="col-lg-8 col-sm-12 text-lg-start text-sm-center">Processo Seletivo <?php echo $row["codigo"] ?> - <?php echo $row["nome"] ?> | Campo Grande</div>
