                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active ms-2 me-2" aria-current="page"
                                href="./pagDemanda.html">Empresas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active ms-2 me-2" aria-current="page"
                                href="./cadastroVagasEmprego.html">Cadastro de Vagas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active ms-2 me-2" aria-current="page"
                                href="./pagBancoTalentos.html">Talentos das Fábricas</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav">
                        <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="row" id="quadradoRoxo-demanda">
                <form class="col-12" id="camposPreenchimentoCadastroAlunoPsg" method="post"
                    action="../../app/session/conexaoCadastroAlunoPsg.php" onsubmit="return validarPost()">
