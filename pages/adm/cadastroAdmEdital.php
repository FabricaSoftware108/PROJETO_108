                        ...
                        <div class="cadastro-adm-edital-container">
                            <div class="col-xs-12 col-sm-auto col-md-auto col-lg-12">
                                <div class="cadastro-adm-edital-container-title">
                                    <h1><?php if (isset($_SESSION['editEdital'])) {
                                            echo 'Edição';
                                        } else {
                                            echo 'Cadastro';
                                        } ?> de Edital</h1>
                                        ...
                                        <div class="col-12" id="tituloCadastroEdital">
                                            ...
                                            <form action="../../app/session/uploadEdital.php" method="post" enctype="multipart/form-data" id="saveEditalForm">
                                                <div class="cadastro-adm-edital-input-container ">
                                                    ...
                                                    <input type="text" name="editalName" size="60" id="cadastroAdmEditalInput" class="form-control cadastro-adm-edital-input" required value="<?php if (isset($_SESSION['editEdital'])) {
                                                                                                                                                                                                    echo ($row['nome']);
                                                                                                                                                                                                } ?>">
                                                </div>
                                                <div class="cadastro-adm-edital-input-container">
                                                    <label for="cadastro-adm-edital-email" class="cadastro-adm-edital-label">Código Do Edital</label>
                                                    <input type="text" name="editalCode" size="10" maxlength="11" id="cadastroAdmEditalInput" class="form-control cadastro-adm-edital-input" required value="<?php if (isset($_SESSION['editEdital'])) {
                                                                                                                                                                                                                    echo ($row['codigo']);
                                                                                                                                                                                                                } ?>" <?php if (isset($_SESSION['editEdital'])) {
                                                                                                                                                                                                                            echo 'disabled';
                                                                                                                                                                                                                        } ?> placeholder="Ex: 00/<?php echo date("Y") ?>">
                                                </div>

                                                <div class="cadastro-adm-edital-input-container">
                                                    <label for="cadastro-adm-edital-limite-aluno" class="cadastro-adm-edital-label">Limite de Alunos</label>
                                                    <input type="number" name="editalLimit" size="10" id="cadastroAdmEditalInput" class="form-control cadastro-adm-edital-input" required value="<?php if (isset($_SESSION['editEdital'])) {
                                                                                                                                                                                                        echo ($row['quantidadeAlunos']);
                                                                                                                                                                                                    } ?>">
                                                </div>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input value="<?php if (isset($_SESSION['editEdital'])) {
                                                                                echo ($row['dataInicio']);
                                                                            } else {
                                                                                echo date('Y-m-d');
                                                                            }  ?>" type="date" class="form-control" id="cadastroAdmEditalDataInicial" max="9999-12-31" name="editalInicialDate" required>
                                                        </div>
                                                        <div class="col-md-6 mt-2 mt-md-0">

                                                            <label for="cadastro-adm-edital-data" id="centerDateFinal" class="cadastro-adm-edital-label-data">Data Final</label>
                                                            <input type="date" class="form-control" id="cadastroAdmEditalDataFinal" max="9999-12-31" name="editalFinalDate" required value="<?php if (isset($_SESSION['editEdital'])) {
                                                                                                                                                                                                echo ($row['dataFim']);
                                                                                                                                                                                            } ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 col-sm-12 text-center">
                                                        <label for="file-input" class="file-label" style="text-align: center;">
                                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="16.000000pt" height="16.000000pt" viewBox="0 0 16.000000 16.000000" preserveAspectRatio="xMidYMid meet">
                                                                <g transform="translate(0.000000,16.000000) scale(0.100000,-0.100000)" fill="grey" stroke="none">
                                                                    <path d="M41 105 c-51 -55 -53 -88 -6 -93 25 -2 39 6 79 47 49 50 55 74 20 88 -17 6 -104 -71 -104 -93 0 -27 21 -23 62 13 l43 37 -40 -42 c-41 -44 -71 -53 -82 -26 -4 10 9 31 38 60 23 24 40 46 37 49 -3 3 -24 -15 -47 -40z m104 4 c-3 -4 -11 -6 -18 -3 -7 2 -26 -9 -42 -26 -16 -16 -33 -30 -39 -30 -6 0 10 20 34 45 33 34 47 42 57 34 7 -6 10 -15 8 -20z" />
                                                                </g>
                                                            </svg>
                                                            <p style="padding-top: 15px;" class="ms-2 ">Arquivo pdf ou docx</p>
                                                            <input type="file" name="editalPDF" id="file-input" class="file-input" title="Arquivo pdf ou docx" value="<?php if (isset($_SESSION['editEdital'])) {
                                                                                                                                                                            echo ($row['arquivo']);
                                                                                                                                                                        } ?>">
                                                ...
                                                <div class="button-cadastrar-edital-adm">
                                                    <button type="submit" class="btn btn-primary" <?php if (isset($_SESSION['editEdital'])) {
                                                                                                        echo 'onclick="actionToEdit()"';
                                                                                                    } ?>><?php if (isset($_SESSION['editEdital'])) {
                                                                                                                echo 'Salvar';
                                                                                                            } else {
                                                                                                                echo 'Cadastrar';
                                        ...
                                        <div class="cadastro-adm-edital-container">
                                            <div class="col-12">
                                                ...
                                                <div class="container mt-1">
                                                    <input type="text" size="34" maxlength="11" id="cadastroAdmEditalInputEdital" class="form-control cadastro-adm-edital-input mt-3 shadow-none" placeholder="Digite o Edital que deseja procurar...">
                                                </div>
