...
<body class="body-relatorioAluno_adm">
  ...
  <main class="main-relatorioEmpresa_adm">
    <div class="container-fluid">
      <!-- <div class="container"> -->

      <div class="imagem-do-relatorio-empresa-adm">
        <img src="../../Imagens/imagem_relatorio_empresa.svg" class="img-fluid">
      </div>
      <div class="row">
        <div class="col-12">
          <div class="relatorioEmpresaAdm">
            <div class="relatorio-empresa-adm-centered">
              <div class="relatorio-empresa-adm-container">
                <div class="col-12">
                  <div class="relatorio-edital-adm-container-title">
                    <h1>Demanda Empresa</h1>
                  </div>
                  <!-- <div class="container mt-3"> -->
                  <input type="text" size="40" maxlength="11" id="relatorioEmpresaAdmInput"
                    class="form-control relatorio-empresa-adm-input" placeholder="Digite o nome do edital que procura.">
                  <!-- </div> -->
                </div>
