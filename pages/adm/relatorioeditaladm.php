...
<body class="body-relatorio-edital-do-aluno">
  ...
  <header>
    <nav class="navbar navbar-dark bg-primary fixed-top nav-adm">
      <div class="container-fluid">
        ...
        <a class="navbar-brand me-auto fs-2 fw-bold" id="titulo-cabecalho-adm" href="./admHome.php">Área de
          Administração Hub Fábricas</a>
  ...
  <nav class="navbar navbar-dark bg-primary fixed-top nav-adm">
    <div class="container-fluid">
      ...
      <a class="navbar-brand me-auto fs-2 fw-bold" id="titulo-cabecalho-adm" href="#">Área de Administração Hub
        Fábricas</a>
      <a class="navbar-brand md-auto fs-6" id="nome-cabecalho-adm" href="#"><?php echo $_SESSION['nome'] ?></a>
      <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar"
        aria-labelledby="offcanvasDarkNavbarLabel">
          ...
          <div class="relatorio_edital_do_aluno-container">
            <div class="relatorio_edital_do_aluno-background-container">
              <div class="relatorio_edital_do_aluno-header">
                <div class="relatorio_edital_do_aluno-title">Relatório do Edital do Aluno -
                  <?php echo $_SESSION['editalCode'] ?></div>
              </div>
