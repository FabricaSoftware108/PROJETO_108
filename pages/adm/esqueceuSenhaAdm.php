...
<html lang="pt-br">
    ...
    <body class="pag-login-ADM">
        ...
        <a href="./loginAdm.html"><svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-arrow-left-circle-fill mx-2 my-4" viewBox="0 0 16 16">
