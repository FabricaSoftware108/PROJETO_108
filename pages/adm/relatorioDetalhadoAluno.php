...
$alunoCode = $_GET['alunoCode'];

$query = "SELECT * FROM alunosPsg WHERE id = $alunoCode";
...
<head>
  ...
  <title>Relatório Edital do Aluno</title>
          ...
          <div class="relatorio_edital_do_aluno-container">
            <div class="relatorio_edital_do_aluno-background-container">
              ...
              <div class="relatorio_edital_do_aluno-content">
                ...
                <a id="relatorio-vagasEmpregoDetalhado-bt-btn" href="../../app/session/gerarPdf.php?index=<?php echo $alunoCode; ?>" class="btn btn-primary relatorio-detalhado-ve-btn">Imprimir</a>
                </div>
            </div>
          </div>
        </div>
