...
<body class="bodyFabricaJogos">
        ...
        <div class="container conteudo-introdu-jogos d-flex justify-content-center align-items-center py-5">
          ...
          <div class="container py-5">
            ...
            <div class="col-12 col-md-6 col-lg-4 text-center">
                <a class="btn btn-fabrica-jogos text-light rounded-pill w-100" href="../editais/pagEdital.php">Editais para alunos</a>
            </div>
            </div>
            </div>
            </div>
  ...
  <div class="container-fluid py-1 rodape-branco">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top container align-items-center">
      ...
      <p class="col-md-4 mb-0 text-light justify-content-center order-lg-1 order-sm-3 copText"  style="cursor: pointer;" onclick="location.href='../developers/developers.html'"><u>© 2024 Fábrica de Software 108</u></p>
