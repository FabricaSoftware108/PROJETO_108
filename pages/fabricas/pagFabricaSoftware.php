...
<body class="bodyFabricaSoftware">
  <!-- Header -->
  ...
  <!-- Main -->
  <main class="main-fabrica-de-software border-0 bg-light">

    <!-- Primeira parte Fábrica de Software -->
    <div class="roxo-introdu-software border-0">
      <div class="branco-introdu-software border-0 bg-light rounded-start-pill py-5">
        <div class="container conteudo-introdu-software d-flex justify-content-center align-items-center py-5">
          <img src="../../Imagens/image-01.png" alt="imagemnumeros" class="code-background-software w-100 img-fluid">
          ...
          <div class="container py-5">
            ...
            <div class="row">
              <p class="col-12">A Fábrica de Software é um projeto que simula uma empresa de desenvolvimento de
                software, visando criar experiências interativas personalizadas e de alta qualidade. Além da produção de
                software, o projeto visa formar profissionais qualificados para a indústria de entretenimento digital.
                Os times de alunos são designados para desenvolver soluções únicas, assumindo responsabilidade desde a
    ...
    <!-- Segunda parte Fábrica de Software (Carrossel)-->
    <div class="lightEffectGames"></div>
    <div class="branco-projetos-software bg-light">
      <div class="roxo-projetos-software py-5">
        <div class="container-fluid">
    ...
    <!-- Terceira parte Fábrica de Software (Requisitos)-->
    <div class="roxo-requisitos-software border-0">
      <div
        class="container-fluid branco-requisitos-software bg-light d-flex justify-content-center align-items-center py-5">
        <div class="container py-5">
          <div class="row py-5">
    ...
    <!-- Quarta parte Fábrica de software (Grade)-->
    <div class="body-da-grade-software py-5">
      <div class="grade-container-software py-5">
        <br>
        <h1 class="titulo-grade-software" style="color: white;">Grade Curricular</h1>
        <br>
        <br>
        <div class="primeira-grade-software">
          <p class="d-inline-flex gap-1">
            <button class="btn btn-danger" style="background-color: blueviolet;" data-bs-toggle="collapse"
              href="#collapseExample1-software" role="button" aria-expanded="false" aria-controls="collapseExample"
              id="botao-grade-software">
              Oferta 1 - Técnico em Desenvolvimento de Sistemas ▼
            </button>
          </p>
          <div class="collapse" id="collapseExample1-software">
            <div class="card card-body">
              <table class="table-grade-software">
                <tr>
                  <th class="th-grade-software">Unidade Curricular</th>
                  <th class="th-grade-software">Carga Horária</th>
                </tr>
                <tr>
                  <td class="td-class-1-software">UC 1 - Analisar requisitos e funcionalidades da aplicação </td>
                  <td class="td-class-1-software">108 horas</td>
                </tr>
                <tr>
                  <td class="td-class-2-software">UC 2 - Auxiliar na gestão de projetos de Tecnologia da Informação</td>
                  <td class="td-class-2-software">60 Horas</td>
                </tr>
                <tr>
                  <td class="td-class-1-software">UC 3 - Desenvolver algoritmos</td>
                  <td class="td-class-1-software">108 Horas</td>
                </tr>
                <tr>
                  <td class="td-class-2-software">UC 4 - Analisar programação estruturada e orientada a objetos</td>
                  <td class="td-class-2-software">48 Horas</td>
                </tr>
              </table>
            </div>
          </div>
        ...
        <div class="segunda-grade-software">
          <button class="btn btn-danger" style="background-color: blueviolet;" type="button" data-bs-toggle="collapse"
            data-bs-target="#collapseExample2-software" aria-expanded="false" aria-controls="collapseExample"
            id="botao-grade-software">
            Oferta 2 - Técnico em Desenvolvimento de Sistemas ▼
          </button>
          </p>
          <div class="collapse" id="collapseExample2-software">
            <div class="card card-body">
              <table class="table-grade-software">
                <tr class="tr-grade-software">
                  <th class="th-grade-software">Unidade Curricular</th>
                  <th class="th-grade-software">Carga Horária</th>
                </tr>
                <tr>
                  <td class="td-class-1-software">UC 5 - Desenvolver aplicações desktop</td>
                  <td class="td-class-1-software">140 Horas</td>
                </tr>
                <tr>
                  <td class="td-class-2-software">UC 6 - Criar e manter Banco de Dados</td>
                  <td class="td-class-2-software">108 Horas</td>
                </tr>
                <tr>
                  <td class="td-class-1-software">UC 7 - Desenvolver aplicações web</td>
                  <td class="td-class-1-software">140 Horas</td>
                </tr>
                <tr>
                  <td class="td-class-2-software">UC 8 - Desenvolver aplicações mobile</td>
                  <td class="td-class-2-software">140 Horas</td>
                </tr>
              </table>
            </div>
          </div>
        ...
        <br>
        <div class="terceira-grade-software">
          <button class="btn btn-danger" style="background-color: blueviolet;" type="button" data-bs-toggle="collapse"
            data-bs-target="#collapseExample3-software" aria-expanded="false" aria-controls="collapseExample"
            id="botao-grade-software">
            Oferta 3 - Técnico em Desenvolvimento de Sistemas ▼
          </button>
          </p>
          <div class="collapse" id="collapseExample3-software">
            <div class="card card-body">
              <table class="table-grade-software">
                <tr class="tabel-tr-software">
                  <th class="th-grade-software">Unidade Curricular</th>
                  <th clas="th-grade-software">Carga Horária</th>
                </tr>
                <tr>
                  <td class="td-class-1-software">UC 9 - Realizar operações de atualização e manutenção em aplicações
                    desenvolvidas</td>
                  <td class="td-class-1-software">96 Horas</td>
                </tr>
                <tr>
                  <td class="td-class-2-software">UC 10 - Realizar testes nas aplicações desenvolvidas</td>
                  <td class="td-class-2-software">108 Horas</td>
                </tr>
                <tr>
                  <td class="td-class-1-software">UC 11 - Realizar operações de suporte junto ao usuário</td>
                  <td class="td-class-1-software">84 Horas</td>
                </tr>
                <tr>
                  <td class="td-class-2-software">UC 12 - Projeto Integrador Desenvolvedor de aplicações</td>
                  <td class="td-class-2-software">60 Horas</td>
                </tr>
              </table>
            </div>
