...
<body class="bodyFabricaAudiovisual">
  ...
  <main class="main-fabrica-de-audiovisual border-0 bg-light">
      ...
      <div class="branco-introdu-audiovisual border-0 bg-light rounded-start-pill py-5">
        <div class="container conteudo-introdu-software d-flex justify-content-center align-items-center py-5">
          ...
          <div class="container py-5">
            ...
            <div class="row">
              <p class="col-12">A Fábrica de Áudio e Vídeo é um projeto que visa a concepção e entrega de produtos
                audiovisuais realizados pelos alunos que colocam em prática os conhecimentos e competências
                desenvolvidas ao longo do curso. O projeto é desenhado por meio de um atendimento corporativo, atendendo
                uma demanda de mercado, seja de um parceiro Senac ou até mesmo da própria Instituição. Seu objetivo é
                proporcionar ao time de alunos uma experiência prática e imersiva na criação de conteúdo de alta
                qualidade, com produção e edição de produtos audiovisuais. Essa abordagem permite que os alunos
                vivenciem todas as etapas de desenvolvimento de projetos audiovisuais, preparando-os para os desafios do
                mercado de trabalho. No desenvolvimento do projeto, eles têm a oportunidade de trabalhar com
                equipamentos profissionais, software de edição e produção, e aprender com profissionais do mercado.
    ...
    <div class="verde-requisitos-audiovisual border-0">
      <div
        class="container-fluid branco-requisitos-audiovisual bg-light d-flex justify-content-center align-items-center py-5">
        <div class="container py-5">
          <div class="row py-5">
          ...
          <div class="grade-container-audiovisual py-5">
            ...
            <div class="primeira-grade-audiovisual">
              <p class="d-inline-flex gap-1">
                <button class="btn btn-success" data-bs-toggle="collapse" href="#collapseExample1-audiovisual"
                  role="button" aria-expanded="false" aria-controls="collapseExample" id="botao-grade-audiovisual">
            ...
            <div class="segunda-grade-audiovisual">
              <button class="btn btn-success" type="button" data-bs-toggle="collapse"
                data-bs-target="#collapseExample2-audiovisual" aria-expanded="false" aria-controls="collapseExample"
                id="botao-grade-audiovisual">
            ...
            <div class="terceira-grade-audiovisual">
              <button class="btn btn-success" type="button" data-bs-toggle="collapse"
                data-bs-target="#collapseExample3-audiovisual" aria-expanded="false" aria-controls="collapseExample"
                id="botao-grade-audiovisual">
