      ...
      <div class="branco-introdu-cgi border-0 bg-light rounded-start-pill py-5">
        <div class="container conteudo-introdu-jogos d-flex justify-content-center align-items-center py-5">
          <div class="container py-5">
            ...
            <div class="row">
              <p class="col-12">A Fábrica de Computação Gráfica é um projeto que simula uma empresa de produção de elementos visuais digitais, atendendo a uma demanda de mercado ou do Senac MS.
                Seu objetivo é criar experiências interativas personalizadas e de alta qualidade, além de formar profissionais qualificados para atender à demanda de mídia e entretenimento. Os times de alunos são designados para desenvolver soluções únicas, assumindo responsabilidade desde a concepção até a entrega do produto final. Essa abordagem prática permite que os alunos vivenciem todas as etapas de desenvolvimento de projetos, preparando-os para os desafios do mercado de trabalho.
          ...
          <div class="grade-container-cgi py-5">
            ...
            <div class="primeira-grade-cgi">
              <p class="d-inline-flex gap-1">
                <button class="btn btn-warning" data-bs-toggle="collapse" href="#collapseExample1-cgi" role="button" aria-expanded="false" aria-controls="collapseExample" id="botao-grade-cgi">
            ...
            <div class="segunda-grade-cgi">
              <button class="btn btn-warning" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample2-cgi" aria-expanded="false" aria-controls="collapseExample" id="botao-grade-cgi">
            ...
            <div class="terceira-grade-cgi">
              <button class="btn btn-warning" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample3-cgi" aria-expanded="false" aria-controls="collapseExample" id="botao-grade-cgi">
