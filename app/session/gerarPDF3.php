...
$query = "SELECT * FROM bancosTalentos WHERE cpf = $index";
...
<div class='container'>
    ...
    <div class='content'>
        <table class='details'>
            ...
            <tr class='details-row'>
                <td class='details-label'>Escolaridade:</td>
                <td class='details-cell'>{$row['escolaridade']}</td>
            </tr>
            <tr class='details-row'>
            ...
            <tr class='details-row'>
                <td class='details-label'>Linkedin:</td>
                <td class='details-cell'>{$row['linkedin']}</td>
            </tr>
            <tr class='details-row'>
                <td class='details-label'>GitHub:</td>
                <td class='details-cell'>{$row['github']}</td>
            </tr>
        </table>
    </div>
</div>
