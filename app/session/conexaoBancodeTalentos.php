 <?php include '../db/connection.php';
    ...
    if (!empty($_POST["nome"]) && !empty($_POST["cep"]) && !empty($_POST["cpf"]) && !empty($_POST["escolaridade"]) && !empty($_POST["dataNascimento"]) && !empty($_POST["email"]) && !empty($_POST["telefone"]) && !empty($_POST["estado"]) && !empty($_POST["rua"]) && !empty($_POST["bairro"]) && !empty($_POST["cidade"]) && !empty($_POST["numero"]) && !empty($_POST["github"]) && !empty($_POST["linkedin"])) {
